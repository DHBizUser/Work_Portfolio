...
\resumeSubHeadingListStart
  ...
  \resumeSubheading
    ...
    {[[ edu.degree|latex_escape]][% if edu.cgpa %]; CGPA: [[ edu.cgpa|latex_escape]][% endif %]}{[[ edu.duration|latex_escape]]}
  [% if edu.courses %]
    \resumeItemListStart
...
\resumeSubHeadingListStart
  [% for item in honors %]
    \item \small{
      \begin{tabular*}{0.97\textwidth}{l@{\extracolsep{\fill}}r}
        \textbf{[[ item.title|latex_escape]]} & [[ item.year|latex_escape]] \\
      \end{tabular*}
    }
  [% endfor %]
\resumeSubHeadingListEnd
...
\resumeSubHeadingListStart
  [% for cert in certificates %]
    \resumeSubheading
      {[[ cert.name|latex_escape]]}{[[ cert.issuer|latex_escape]]}
      {\href{[[ cert.link|latex_escape]]}{Link}}{[[ cert.start_end|latex_escape]]}
  [% endfor %]
\resumeSubHeadingListEnd
[% endif %]
